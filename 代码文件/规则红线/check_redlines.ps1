...
.SYNOPSIS
    铁律量化 · 自动化红线合规检查脚本
.DESCRIPTION
    对照规则红线 v1.3 的 6 大检查维度，验证当前项目状态。
...
$versionFiles = @(
    "$BASE\规则红线\分析的规则红线--Claude_v1.4.md"
    "$BASE\每日荐股\分析逻辑\每日荐股分析逻辑白皮书_v2.4.md"
    "$BASE\每日荐股\分析逻辑\每日荐股分析逻辑白皮书_v2.3.md"
    "$BASE\每日荐股\分析逻辑\每日荐股分析逻辑白皮书_v2.1.md"
    "$BASE\每日荐股\事后评估\次日后评估白皮书_v1.5.md"
    "$BASE\每日荐股\事后评估\次日后评估白皮书_v1.4.md"
    "$BASE\重点股票\分析逻辑\重点股票跟踪分析逻辑白皮书_v1.2.md"
