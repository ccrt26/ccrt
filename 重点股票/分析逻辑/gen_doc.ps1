...
function New-KeystockDocBody {
    ...
    AddE $sb
    [void]$sb.Append('<w:p><w:pPr><w:jc w:val="center"/></w:pPr><w:r><w:rPr><w:rFonts w:eastAsia="Microsoft YaHei"/><w:sz w:val="36"/><w:b/><w:color w:val="16213E"/></w:rPr><w:t>' + [System.Security.SecurityElement]::Escape("v1.1") + '</w:t></w:r></w:p>')
    AddE $sb
    ...
    [void]$sb.Append('<w:p><w:pPr><w:jc w:val="center"/></w:pPr><w:r><w:rPr><w:rFonts w:eastAsia="Microsoft YaHei"/><w:sz w:val="20"/><w:color w:val="666666"/></w:rPr><w:t>' + [System.Security.SecurityElement]::Escape("版本：v1.1 | 2026-05-21 | 体系定位：对重点标的进行多层次、多维度、多周期的深度分析") + '</w:t></w:r></w:p>')
    AddE $sb; AddE $sb
    AddH $sb "版本历史" 1
    ...
    AddBP $sb "短期预判输出格式：方向(看多/偏多/中性/偏空/看空) 关键阻力位 关键支撑位 短期催化剂 置信度(高>70%/中50-70%/低<50%)"
    ...
    [void]$sb.Append('<w:p><w:pPr><w:jc w:val="center"/></w:pPr><w:r><w:rPr><w:rFonts w:eastAsia="Microsoft YaHei"/><w:sz w:val="18"/><w:color w:val="999999"/></w:rPr><w:t>' + [System.Security.SecurityElement]::Escape("版本：v1.1 | 2026-05-21 | 铁律量化") + '</w:t></w:r></w:p>')
    return $sb.ToString()
}
# Main
$docPath = [System.IO.Path]::GetFullPath("C:\Users\34269\Documents\Claude\股票分析\重点股票\分析逻辑\重点股票跟踪分析逻辑白皮书_v1.1.docx")
